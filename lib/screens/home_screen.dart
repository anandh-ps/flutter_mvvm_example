import 'package:flutte_mvvm/apis/api_response.dart';
import 'package:flutte_mvvm/models/media_model.dart';
import 'package:flutte_mvvm/viewmodel/media_view_model.dart';
import 'package:flutte_mvvm/widgets/player.dart';
import 'package:flutte_mvvm/widgets/player_list.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Flutter MVVM Media Player'),
      ),
      body: Column(
        children: <Widget>[
          Padding(
